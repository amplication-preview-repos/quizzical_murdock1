...
class LocaleCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => PropertyTranslationCreateNestedManyWithoutLocalesInput,
  })
  @ValidateNested()
  @Type(() => PropertyTranslationCreateNestedManyWithoutLocalesInput)
  @IsOptional()
  @Field(() => PropertyTranslationCreateNestedManyWithoutLocalesInput, {
    nullable: true,
  })
  propertyTranslations?: PropertyTranslationCreateNestedManyWithoutLocalesInput;
}

export { LocaleCreateInput as LocaleCreateInput };
