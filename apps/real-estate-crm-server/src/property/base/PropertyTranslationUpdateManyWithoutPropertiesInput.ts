...
@InputType()
class PropertyTranslationUpdateManyWithoutPropertiesInput {
...
export { PropertyTranslationUpdateManyWithoutPropertiesInput as PropertyTranslationUpdateManyWithoutPropertiesInput };
